...
# GST/Tax is intentionally excluded from the standard cost-sheet model and Excel output.
...
8. **Profit** = Cost of Sales × Target Profit % on Cost
9. **Sales Value** = Cost of Sales + Profit
