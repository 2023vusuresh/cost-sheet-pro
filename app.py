...
if "cost_lines" not in st.session_state:
    st.session_state.cost_lines = [
        {"Category": "Direct Material", "Cost Component": "Raw Materials", "Qty / Units": 1000.0, "Rate": 50.0},
...
material = cat_total("Direct Material")
...
2. **Works / Factory Cost** = Prime Cost + Factory Overhead + Opening WIP − Closing WIP  
3. **Cost of Production** = Works / Factory Cost + Administration Overhead  
4. **Cost of Goods Sold** = Cost of Production + Opening Finished Goods − Closing Finished Goods  
5. **Cost of Sales** = Cost of Goods Sold + Selling & Distribution Overhead  
