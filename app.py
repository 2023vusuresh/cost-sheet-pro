...
st.markdown(
    '<div class="info-box"><b>Select every cost individually.</b> Choose a category and cost component, enter the <b>Total Quantity / Units</b> and choose whether the question gives <b>Total Amount</b> or <b>Rate / Unit</b>. The system automatically calculates the other value.'
